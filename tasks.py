...
@task
def train(ctx: Context, profile: bool = False) -> None:
    """Train model with optional PyTorch profiler."""
    cmd = f"uv run -m {PROJECT_NAME}.workflows.train {'profile=True' if profile else ''}"
